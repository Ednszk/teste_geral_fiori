sap.ui.define([
	...
	return Opa5.extend("nspbapi1.pbapi1.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["nspbapi1/pbapi1/localService/mockserver"], function (mockserver) {
