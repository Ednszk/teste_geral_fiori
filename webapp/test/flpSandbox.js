		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "teste bapi lista normal",
									"targetURL": "#testebapilistanormal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testebapilistanormal-display": {
								"semanticObject": "testebapilistanormal",
								"action": "display",
								"description": "Teste bapi lista normal",
								"title": "teste bapi lista normal",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nspbapi1.pbapi1",
									"url": sap.ui.require.toUrl("nspbapi1/pbapi1")
								}
							}
						}
					}
