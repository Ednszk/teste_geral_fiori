		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Torre de Controle Fiscal",
									"targetURL": "#torrectrlfiscal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"torrectrlfiscal-display": {
								"semanticObject": "torrectrlfiscal",
								"action": "display",
								"description": "Torre de Controle Fiscal",
								"title": "Torre de Controle Fiscal",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nstorretotalnf.torretotalnf",
									"url": sap.ui.require.toUrl("nstorretotalnf/torretotalnf")
								}
							}
						}
					}
